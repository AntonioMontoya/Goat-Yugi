    ...
    <section class="page ladder-page">
      ...
      <div class="ranked-center-matchmaking">
        <div class="ranked-cta-plate">
          <img src="./sprites/Sprite_Ornamentacion.webp" class="ranked-plate-ornament left" alt="" aria-hidden="true" />
          ...
          <img src="./sprites/Sprite_Ornamentacion.webp" class="ranked-plate-ornament right" alt="" aria-hidden="true" />
        </div>
      </div>
