...
function bindEvents() {
  ...
  document.querySelector("#play-deck")?.addEventListener("change", (event) => {
  ...
  document.querySelector("#play-opponent-deck")?.addEventListener("change", (event) => {
    const nextDeckId = event.target.value;
