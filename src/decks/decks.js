...
const CORE_DECK_PRESETS = [
  ...
  preset({ id: "warrior", name: "Warrior / Anti-Meta", archetype: "Aggro / Anti-meta", readiness: VALIDATION_STATUS.SUPPORTED, provenance: "goatformat-deck-list", source: "https://www.goatformat.com/warrior.html", notes: "Lista de torneo oficial de Sean Montague (Top 4 Clash of Champions) documentada en GoatFormat.com.", core: [], filler: [] }),
